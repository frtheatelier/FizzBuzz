...
- [x] In your main method in `Main.java`, try making a call to your private helper — something like
...
> **debatable.** personally, no change but if we consider someone inexperienced, it may be less readable.
> The new line basically means: print the outcome of this function but to some it looks like a jumbled mess.
> The previous version means: save the outcome as this variable and print it. much more tedious and uses up space
> but it breaks it down for the common man. sort of.
...
> Trivial. **Set theory** can be applied. See [Multiples.java](src/lab1/Multiples.java) for the code and breakdown
